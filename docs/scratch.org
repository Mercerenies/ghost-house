...
** Plan
   ...
   6. [-] Locked door generator stage after properties generator
      ...
      - [ ] Heuristic for closeting the player into the starting room
   ...
   7. [-] Keys
      ...
      - [ ] Debug menu option to give the player several keys
...
** Lock Placement
  + [-] Heuristics (minimum 1 point always)
    ...
    - [ ] -30 for being a closet edge which boxes the player into the
      starting room
* GENERATOR STAGES
  Listed here, for convenience.
   ...
   6. LockedDoorGenerator
   7. ActualizingGenerator
   8. SpecialGenerator
   9. EdgeGenerator
  10. ItemGenerator
  11. AmbientEnemyGenerator
  12. PlayerGenerator
  13. GhostGenerator
